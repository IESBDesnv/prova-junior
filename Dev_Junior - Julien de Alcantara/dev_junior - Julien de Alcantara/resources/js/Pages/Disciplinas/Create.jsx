...
export default function Create() {
    ...
    const submit = (e) => {
        ...
        post(route('disciplinas.store'), {
            onSuccess: () => {
                console.log('Sucesso na criação! Mostrando modal...');
            ...
            onError: (errors) => {
                console.log('Erro na criação:', errors);
            },
            onFinish: () => {
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-gray-600 mt-1">
                                    Adicione uma nova disciplina à nossa escola criativa
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex gap-4 pt-6">
                                <InfantilButton
                                    ...
                                    className="flex-1"
                                >
                                    {processing ? 'Criando...' : '✨ Criar Disciplina'}
                                </InfantilButton>
